...
public class ApplicationRunner {
    ...
    private static void getInputData(String[] inArr) {
        for (int i = 0; i < inputDataArr.length; i++) {
            inputDataArr[i] = inArr[i];
        }
    }
    ...
    public static void main(String[] args) {
       ...
       // ParserPrototype parser = new ParserPrototype(author, title, yearPublished, genre); // Create the parser object
         ...
         * String[] results = parser.retrieveRecordByAuthorTitle("records", author,
         * title);
         * 
         * 
         ...
         * 
         * // These results are type Hashmap (same results as above, but different data
         * type)
         * HashMap<String, Integer> distinctWordHashmap =
         * parser.retrieveHashMapByAuthorTitle("records", "DISTINCT_WORDS", author,
         * title);
         * HashMap<String, Integer> distinctPunctuationHashmap =
         * parser.retrieveHashMapByAuthorTitle("records", "DISTINCT_PUNCTUATION",
         * author, title);
